...
public class AdminTableDarkStatus extends JTable {

    private TableDarkHeader header;
    private TableDarkCell cell;

    public AdminTableDarkStatus() {
    ...
    private class TableDarkCell extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln, boolean bln1, int row, int column) {
            ...
            if (column == 2) {
                if (o != null) {
                    AdminStatusType status = AdminStatusType.valueOf(o.toString());

                    if (status == AdminStatusType.ENABLED) {
                        setText("ENABLED");
            ...
            setFont(boldFont);
            } else if (alignment.containsKey(column)) {
